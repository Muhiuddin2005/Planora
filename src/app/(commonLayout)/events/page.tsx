...
export default function ExploreEventsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 mb-8 shadow-sm flex flex-col space-y-4">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 bg-white border-slate-200 focus-visible:ring-indigo-600"
            />
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2 border-t border-slate-200/60 pt-4">
          ...
          <Button
            ...
            className={filterType === "PUBLIC_FREE" ? "bg-indigo-600 hover:bg-indigo-700" : ""}
          >
            Public Free
          </Button>
          <Button
            ...
            className={filterType === "PUBLIC_PAID" ? "bg-indigo-600 hover:bg-indigo-700" : ""}
          >
            Public Paid
          </Button>
          {isAdmin && (
            <>
              <Button
                ...
                className={filterType === "PRIVATE_FREE" ? "bg-indigo-600 hover:bg-indigo-700" : ""}
              >
                Private Free
              </Button>
              <Button
                ...
                className={filterType === "PRIVATE_PAID" ? "bg-indigo-600 hover:bg-indigo-700" : ""}
              >
                Private Paid
              </Button>
            </>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredEvents.map((event) => {
            ...
            return (
              <Card
                key={event.id}
                className="flex flex-col shadow-sm hover:shadow-md transition-all duration-300 border-slate-200 hover:border-indigo-100 hover:-translate-y-0.5 bg-white rounded-xl group overflow-hidden"
              >
                {/* Event Image Banner */}
                ...
                <CardFooter className="pt-0 border-t border-slate-50 mt-4">
                  <Link href={`/events/${event.id}`} passHref className="w-full mt-4">
                    <Button className="w-full bg-slate-900 hover:bg-slate-800 shadow-sm flex items-center justify-center gap-1 font-semibold">
                      View Details
                    </Button>
                  </Link>
                </CardFooter>
